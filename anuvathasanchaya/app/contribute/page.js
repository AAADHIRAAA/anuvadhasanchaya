  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:8000/translation/create",
        {
          formData,
        }
      );
            ...
            <form className="p-4 border shadow-lg" onSubmit={handleSubmit}>
              ...
              <div className="mb-3">
                <div class="form-group row">
                  <label htmlFor="bookTitle" class="col-sm-2 col-form-label">
                    BookTitle<span className="text-danger">*</span>
                  </label>
                  <div class="col-sm-10">
                    <input
                      type="text"
              ...
              <div className="mb-3">
                <div class="form-group row">
                  <label htmlFor="author" class="col-sm-2 col-form-label">
              ...
              <div className="mb-3">
                <div class="form-group row">
                  <label htmlFor="publisher" class="col-sm-2 col-form-label">
                    Publisher
                  </label>
                  <div class="col-sm-10">
                    <input
              ...
              <div className="mb-3">
                <div class="form-group row">
                  <label htmlFor="editor" class="col-sm-2 col-form-label">
                    Editor
                  </label>
                  <div class="col-sm-10">
                    <input
              ...
              <div className="mb-3">
                <div class="form-group row">
                  <label htmlFor="language" class="col-sm-2 col-form-label">
                  ...
                  <div class="col-sm-10">
                    <input
                      ...
                      id="language"
                      name="language"
                      placeholder="Enter translated Language"
              ...
              <div className="mb-3">
                <div class="form-group row">
                  <label htmlFor="year" class="col-sm-2 col-form-label">
                    Year
                  </label>
                  <div class="col-sm-10">
                    <input
              ...
              <div className="mb-3">
                <div class="form-group row">
                  <label htmlFor="url" class="col-sm-2 col-form-label">
                    URL
                  </label>
                  <div class="col-sm-10">
                    <input
              ...
              {translate && (
                <div>
                  <div className="mb-3">
                    <div class="form-group row">
                      <label
                        htmlFor="originalBook"
                        class="col-sm-2 col-form-label"
                      >
                        OriginalBook<span className="text-danger">*</span>
                      </label>
                      <div class="col-sm-10">
                        <input
                          type="text"
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input
                          type="text"
                          class="form-control border border-black"
                          id="originalPublisher"
                          name="originalPublisher"
                          placeholder="Enter Publisher Name"
                          value={formData.originalPublisher}
                          onChange={handleInputChange}
                        />
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input
                          ...
                          id="originalUrl"
                          name="originalUrl"
                          placeholder="Enter Original Book URL"
